...
function logout()
{
	window.document.PublicForm.action="publicRequest.do?parameter=publicLogoutRequest";
...
<html:form  action="publicRequest.do?parameter=publicChat" name="PublicForm"  type="relationship.forms.PublicForm">
...
<div id="show" align="center"></div>
  ...
  <div align="left">
    ...
    <input type="hidden" name="public_Id" id="public_Id" value="<%if(session.getAttribute("public_Id")==null){%><%}else{%><%=session.getAttribute("public_Id")%><%}%>">
</html:form>
